...
```
cd existing_repo
git remote add origin https://gitlab.com/anthonygnolan/sample-spring-application.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/anthonygnolan/sample-spring-application/-/settings/integrations)
